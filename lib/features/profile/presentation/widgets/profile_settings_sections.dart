              ...
              _buildPrivacyRow(
                ...
                onSwitchChanged: (value) async {
                  ...
                  try {
                    ...
                    await const BiometricSetupRoute().push(context);
                  } catch (error) {
                    if (context.mounted)
                      errorToast(BiometricService.errorMessage(error));
                  } finally {
          ...
          child: Column(
            children: [
              _buildSupportRow(
                ...
                title: 'Help Center',
                onTap: () => const HelpCenterRoute().push(context),
              ),
              Divider(color: ColorName.lightBackground3, height: 1),
              _buildSupportRow(
              ...
              _buildSupportRow(
                ...
                onTap: () => const TermsConditionsRoute().push(context),
              ),
            ],
          ),
        ),
